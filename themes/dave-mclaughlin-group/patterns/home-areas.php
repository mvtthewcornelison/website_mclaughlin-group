...
<section class="wp-block-group alignfull has-gray-50-background-color has-background" style="padding-top:7rem;padding-right:2rem;padding-bottom:7rem;padding-left:2rem">
	...
	<div class="wp-block-buttons">
		...
		<div class="wp-block-button"><a class="wp-block-button__link has-white-color has-black-background-color has-text-color has-background wp-element-button" href="/search-homes/" style="border-radius:0px;padding-top:0.875rem;padding-right:1.75rem;padding-bottom:0.875rem;padding-left:1.75rem;font-weight:500;letter-spacing:0.02em">Begin your search</a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
